  ...
  return (
      <div className="relative overflow-hidden m-3">
        ...
        <ScrollBaseAnimation
          ...
          clasname="font-bold tracking-[-0.05em] leading-[90%] bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 light:from-purple-600 light:via-blue-600 light:to-pink-600 bg-clip-text text-transparent">
          {text}
        </ScrollBaseAnimation>
      </div>
  )
