...
// Project Data for Sayaji Infotech
const projects = [
  {
    ...
    color: "bg-gradient-to-br from-blue-600 to-blue-800 dark:from-blue-700 dark:to-blue-900",
    stats: [
  ...
  },
  {
    ...
    color: "bg-gradient-to-br from-teal-600 to-teal-800 dark:from-teal-700 dark:to-teal-900",
    stats: [
  ...
  },
  {
    ...
    color: "bg-gradient-to-br from-cyan-600 to-cyan-800 dark:from-cyan-700 dark:to-cyan-900",
    stats: [
...
export default function ServicesShowcase() {
  ...
  return (
    <main ref={container} className="bg-slate-50 dark:bg-slate-800 transition-colors duration-500">
      {/* Section Header */}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`flex flex-col relative h-[450px] w-[85%] max-w-6xl rounded-3xl p-8 md:p-12 origin-top shadow-2xl ${color} text-white`}
      >
        <div className="flex flex-col lg:flex-row h-full gap-8">
          ...
          <div className="flex flex-col justify-between lg:w-[55%]">
            ...
            <div className="mt-8">
              <Link
                href="/contact"
                className="inline-block px-8 py-3 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full text-white font-semibold transition-all duration-300 hover:transform hover:-translate-y-1"
              >
                Learn More
              </Link>
            </div>
          ...
          {/* Image */}
          <div className="relative lg:w-[45%] h-64 lg:h-full rounded-2xl overflow-hidden bg-white/10 backdrop-blur-sm">
